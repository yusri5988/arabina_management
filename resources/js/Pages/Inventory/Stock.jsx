                        ...
                        <div className="col-span-1 flex items-center justify-end">
                          {(isOut || alacarteLines.length > 1) && (
                            <button
                              ...
                              className="p-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-700 transition duration-150 flex items-center justify-center border border-red-200"
                              title="Remove SKU"
                            >
